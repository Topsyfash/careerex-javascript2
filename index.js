...
const checkAccess = (hasID, isAbove18) => {
    hasID && isAbove18 ? console.log("Access Granted") : console.log("Access Denied")
};
...
// I Tried this and it worked too
function gradeCheck() {
    const studentScores = [88,55, 20, 30, 42, 65, 70, 48,75,99];
    studentScores.map((scores) => {
        scores > 50 ? console.log("passed") : console.log("Failed")
    });
};
gradeCheck();
